...
import com.vonbraunz.apogtnh.deadly.BossPlacer;
...
@Mod(
    modid = ApotheosisGTNH.MODID,
    name = ApotheosisGTNH.NAME,
    version = ApotheosisGTNH.VERSION
)
public class ApotheosisGTNH {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        MinecraftForge.EVENT_BUS.register(new BossPlacer());
        proxy.init(event);
    }
