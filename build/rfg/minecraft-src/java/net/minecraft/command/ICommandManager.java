...
public interface ICommandManager
{
     ...
     */
    List<String> getPossibleCommands(ICommandSender p_71558_1_, String p_71558_2_);

    /**
     * returns all commands that the commandSender can use
     */
    List<net.minecraft.command.ICommand> getPossibleCommands(ICommandSender p_71557_1_);

    /**
     * returns a map of string to commads. All commands are returned, not just ones which someone has permission to use.
     */
    Map<String, net.minecraft.command.ICommand> getCommands();
}