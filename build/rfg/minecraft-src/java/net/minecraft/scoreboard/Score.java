...
public class Score
{
    public static final Comparator<net.minecraft.scoreboard.Score> field_96658_a = new Comparator()
    {
    ...
    public void func_96651_a(List<net.minecraft.entity.player.EntityPlayer> p_96651_1_)
    {
