...
public class Scoreboard
{
    ...
    public Collection<net.minecraft.scoreboard.ScoreObjective> func_96520_a(IScoreObjectiveCriteria p_96520_1_)
    {
    ...
    public Collection<net.minecraft.scoreboard.Score> func_96534_i(ScoreObjective p_96534_1_)
    {
    ...
    public Collection<net.minecraft.scoreboard.ScoreObjective> getScoreObjectives()
    {
    ...
    public Collection<net.minecraft.scoreboard.Score> func_96528_e()
    {
    ...
    public Map<String, net.minecraft.scoreboard.Score> func_96510_d(String p_96510_1_)
    {
     ...
     */
    public Collection<net.minecraft.scoreboard.ScorePlayerTeam> getTeams()
    {
