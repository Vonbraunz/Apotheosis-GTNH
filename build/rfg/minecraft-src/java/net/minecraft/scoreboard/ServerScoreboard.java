...
public class ServerScoreboard extends Scoreboard
{
    ...
    public List<net.minecraft.network.Packet> func_96550_d(ScoreObjective p_96550_1_)
    {
    ...
    public List<net.minecraft.network.Packet> func_96548_f(ScoreObjective p_96548_1_)
    {
        ArrayList arraylist = new ArrayList();
