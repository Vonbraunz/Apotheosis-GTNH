...
public class StatList
{
    ...
    protected static Map<String, net.minecraft.stats.StatBase> oneShotStats = new HashMap();
    public static List<net.minecraft.stats.StatBase> allStats = new ArrayList();
    public static List<net.minecraft.stats.StatBase> generalStats = new ArrayList();
    public static List<net.minecraft.stats.StatCrafting> itemStats = new ArrayList();
    /** Tracks the number of times a given block or item has been mined. */
    public static List<net.minecraft.stats.StatCrafting> objectMineStats = new ArrayList();
