...
public class EntityAINearestAttackableTarget extends EntityAITarget
{
    ...
    public EntityAINearestAttackableTarget(EntityCreature p_i1663_1_, Class<? extends net.minecraft.entity.Entity> p_i1663_2_, int p_i1663_3_, boolean p_i1663_4_)
    {
        this(p_i1663_1_, p_i1663_2_, p_i1663_3_, p_i1663_4_, false);
    }

    public EntityAINearestAttackableTarget(EntityCreature p_i1664_1_, Class<? extends net.minecraft.entity.Entity> p_i1664_2_, int p_i1664_3_, boolean p_i1664_4_, boolean p_i1664_5_)
    {
        this(p_i1664_1_, p_i1664_2_, p_i1664_3_, p_i1664_4_, p_i1664_5_, (IEntitySelector)null);
    }

    public EntityAINearestAttackableTarget(EntityCreature p_i1665_1_, Class<? extends net.minecraft.entity.Entity> p_i1665_2_, int p_i1665_3_, boolean p_i1665_4_, boolean p_i1665_5_, final IEntitySelector p_i1665_6_)
    {
