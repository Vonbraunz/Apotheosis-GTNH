...
public class EntityAIWatchClosest extends EntityAIBase
{
    ...
    public EntityAIWatchClosest(EntityLiving p_i1631_1_, Class<? extends net.minecraft.entity.Entity> p_i1631_2_, float p_i1631_3_)
    {
    ...
    public EntityAIWatchClosest(EntityLiving p_i1632_1_, Class<? extends net.minecraft.entity.Entity> p_i1632_2_, float p_i1632_3_, float p_i1632_4_)
    {
