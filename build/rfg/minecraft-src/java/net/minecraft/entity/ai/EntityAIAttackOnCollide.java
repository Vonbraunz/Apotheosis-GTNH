...
public class EntityAIAttackOnCollide extends EntityAIBase
{
    ...
    Class<? extends net.minecraft.entity.Entity> classTarget;
    ...
    public EntityAIAttackOnCollide(EntityCreature p_i1635_1_, Class<? extends net.minecraft.entity.Entity> p_i1635_2_, double p_i1635_3_, boolean p_i1635_5_)
    {
