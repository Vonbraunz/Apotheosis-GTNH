...
public class JsonToNBT
{
    ...
    static class Compound extends JsonToNBT.Any
        {
            protected ArrayList<net.minecraft.nbt.JsonToNBT.Any> field_150491_b = new ArrayList();
    ...
    static class List extends JsonToNBT.Any
        {
            protected ArrayList<net.minecraft.nbt.JsonToNBT.Any> field_150492_b = new ArrayList();
