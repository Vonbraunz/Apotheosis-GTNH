...
public class PotionHelper
{
     ...
     */
    public static int calcPotionLiquidColor(Collection<net.minecraft.potion.PotionEffect> p_77911_0_)
    {
        int i = 3694022;
    ...
    public static boolean func_82817_b(Collection<net.minecraft.potion.PotionEffect> p_82817_0_)
    {
     ...
     */
    public static List<net.minecraft.potion.PotionEffect> getPotionEffects(int p_77917_0_, boolean p_77917_1_)
    {
