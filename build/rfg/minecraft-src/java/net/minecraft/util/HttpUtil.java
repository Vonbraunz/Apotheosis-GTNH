...
public class HttpUtil
{
    ...
    public static String func_151226_a(URL url, Map<String, Object> data, boolean skipLoggingErrors)
    {
    ...
    public static void func_151223_a(final File packFile, final String packName, final HttpUtil.DownloadListener completionListener, final Map<String, String> requestData, final int maxSize, final IProgressUpdate loadingScreen, final Proxy proxy)
    {
