...
public abstract class ChatComponentStyle implements IChatComponent
{
     ...
     */
    protected List<net.minecraft.util.IChatComponent> siblings = Lists.newArrayList();
     ...
     */
    public List<net.minecraft.util.IChatComponent> getSiblings()
    {
    ...
    public Iterator<net.minecraft.util.IChatComponent> iterator()
    {
     ...
     */
    public static Iterator<net.minecraft.util.IChatComponent> createDeepCopyIterator(Iterable<net.minecraft.util.IChatComponent> components)
    {
