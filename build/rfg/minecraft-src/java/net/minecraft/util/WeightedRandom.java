...
public class WeightedRandom
{
     ...
     */
    public static int getTotalWeight(Collection<? extends net.minecraft.util.WeightedRandom.Item> p_76272_0_)
    {
        int i = 0;
     ...
     */
    public static <T extends net.minecraft.util.WeightedRandom.Item> T getRandomItem(Random p_76273_0_, Collection<T> p_76273_1_, int p_76273_2_)
    {
        if (p_76273_2_ <= 0)
        {
    ...
    public static <T extends net.minecraft.util.WeightedRandom.Item> T getItem(Collection<T> par1Collection, int weight)
    {
        {
            int j = weight;
     ...
     */
    public static <T extends net.minecraft.util.WeightedRandom.Item> T getRandomItem(Random p_76271_0_, Collection<T> p_76271_1_)
    {
