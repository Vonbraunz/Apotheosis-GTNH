...
public class ResourcePackRepository
{
    ...
    public List<net.minecraft.client.resources.ResourcePackRepository.Entry> getRepositoryEntriesAll()
    {
        return ImmutableList.copyOf(this.repositoryEntriesAll);
    }

    public List<net.minecraft.client.resources.ResourcePackRepository.Entry> getRepositoryEntries()
    {
        return ImmutableList.copyOf(this.repositoryEntries);
    }

    public void func_148527_a(List<net.minecraft.client.resources.ResourcePackRepository.Entry> p_148527_1_)
    {
