...
public class SimpleReloadableResourceManager implements IReloadableResourceManager
{
    ...
    private final Map<String, net.minecraft.client.resources.FallbackResourceManager> domainResourceManagers = Maps.newHashMap();
    private final List<net.minecraft.client.resources.IResourceManagerReloadListener> reloadListeners = Lists.newArrayList();
