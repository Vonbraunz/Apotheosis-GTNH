...
public class LanguageManager implements IResourceManagerReloadListener
{
    ...
    public void parseLanguageMetadata(List<net.minecraft.client.resources.IResourcePack> p_135043_1_)
    {
    ...
    public SortedSet<net.minecraft.client.resources.Language> getLanguages()
    {
