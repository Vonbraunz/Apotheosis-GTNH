...
public class BroadcastController implements IStatCallbacks, IStreamCallbacks
{
    ...
    protected List<tv.twitch.broadcast.FrameBuffer> field_152874_j = new ArrayList();
    protected List<tv.twitch.broadcast.FrameBuffer> field_152875_k = new ArrayList();
