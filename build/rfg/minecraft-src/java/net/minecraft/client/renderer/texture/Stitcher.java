...
public class Stitcher
{
    ...
    public List<net.minecraft.client.renderer.texture.Stitcher.Slot> getStichSlots()
    {
    ...
    public static class Slot
        {
             ...
             */
            public void getAllStitchSlots(List<net.minecraft.client.renderer.texture.Stitcher.Slot> p_94184_1_)
            {
                if (this.holder != null)
                {
                    p_94184_1_.add(this);
