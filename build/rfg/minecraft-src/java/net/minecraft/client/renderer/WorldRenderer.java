...
public class WorldRenderer
{
    ...
    public List<net.minecraft.tileentity.TileEntity> tileEntityRenderers = new ArrayList();
    private List tileEntities;
    /** Bytes sent to the GPU */
    private int bytesDrawn;
    private static final String __OBFID = "CL_00000942";

    public WorldRenderer(World p_i1240_1_, List<net.minecraft.tileentity.TileEntity> p_i1240_2_, int p_i1240_3_, int p_i1240_4_, int p_i1240_5_, int p_i1240_6_)
    {
