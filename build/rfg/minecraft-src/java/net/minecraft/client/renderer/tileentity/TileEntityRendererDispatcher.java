...
{
    public Map<Class<? extends net.minecraft.tileentity.TileEntity>, net.minecraft.client.renderer.tileentity.TileEntitySpecialRenderer> mapSpecialRenderers = new HashMap();
    ...
    public TileEntitySpecialRenderer getSpecialRendererByClass(Class<? extends net.minecraft.tileentity.TileEntity> p_147546_1_)
    {
        ...
        {
            tileentityspecialrenderer = this.getSpecialRendererByClass((Class<? extends net.minecraft.tileentity.TileEntity>)p_147546_1_.getSuperclass());
