...
public class RenderManager
{
    ...
    public Map<Class<? extends net.minecraft.entity.Entity>, net.minecraft.client.renderer.entity.Render> entityRenderMap = new HashMap();
    ...
    public Render getEntityClassRenderObject(Class<? extends net.minecraft.entity.Entity> p_78715_1_)
    {
