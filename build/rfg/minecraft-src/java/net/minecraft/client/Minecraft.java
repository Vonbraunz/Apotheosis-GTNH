...
public class Minecraft implements IPlayerUsage
{
    ...
    public Minecraft(Session sessionIn, int displayWidth, int displayHeight, boolean fullscreen, boolean isDemo, File dataDir, File assetsDir, File resourcePackDir, Proxy proxy, String version, Multimap<String, String> twitchDetails, String assetsJsonVersion)
    {
        theMinecraft = this;
    ...
    public Multimap<String, String> func_152341_N()
    {
