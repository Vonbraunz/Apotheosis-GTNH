...
public class GuiResourcePackSelected extends GuiResourcePackList
{
    ...
    public GuiResourcePackSelected(Minecraft p_i45056_1_, int p_i45056_2_, int p_i45056_3_, List<net.minecraft.client.resources.ResourcePackListEntry> p_i45056_4_)
    {
