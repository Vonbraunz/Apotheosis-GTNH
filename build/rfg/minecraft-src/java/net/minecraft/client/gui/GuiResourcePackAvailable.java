...
public class GuiResourcePackAvailable extends GuiResourcePackList
{
    ...
    public GuiResourcePackAvailable(Minecraft p_i45054_1_, int p_i45054_2_, int p_i45054_3_, List<net.minecraft.client.resources.ResourcePackListEntry> p_i45054_4_)
    {
