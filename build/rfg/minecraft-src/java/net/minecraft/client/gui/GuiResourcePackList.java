...
public abstract class GuiResourcePackList extends GuiListExtended
{
    ...
    protected final List<net.minecraft.client.resources.ResourcePackListEntry> field_148204_l;
    private static final String __OBFID = "CL_00000825";

    public GuiResourcePackList(Minecraft p_i45055_1_, int p_i45055_2_, int p_i45055_3_, List<net.minecraft.client.resources.ResourcePackListEntry> p_i45055_4_)
    {
    ...
    public List<net.minecraft.client.resources.ResourcePackListEntry> func_148201_l()
    {
