...
public class S27PacketExplosion extends Packet
{
    ...
    public S27PacketExplosion(double p_i45193_1_, double p_i45193_3_, double p_i45193_5_, float p_i45193_7_, List<net.minecraft.world.ChunkPosition> p_i45193_8_, Vec3 p_i45193_9_)
    {
    ...
    @SideOnly(Side.CLIENT)
    public List<net.minecraft.world.ChunkPosition> func_149150_j()
    {
