...
public enum EnumConnectionState
{
    ...
    protected EnumConnectionState func_150751_a(int p_150751_1_, Class<? extends net.minecraft.network.Packet> p_150751_2_)
    {
        String s;
    ...
    protected EnumConnectionState func_150756_b(int p_150756_1_, Class<? extends net.minecraft.network.Packet> p_150756_2_)
    {
        String s;
    ...
    public BiMap<Integer, Class<? extends net.minecraft.network.Packet>> func_150753_a()
    {
        return this.field_150769_h;
    }

    public BiMap<Integer, Class<? extends net.minecraft.network.Packet>> func_150755_b()
    {
        return this.field_150770_i;
    }

    public BiMap<Integer, Class<? extends net.minecraft.network.Packet>> func_150757_a(boolean p_150757_1_)
    {
        return p_150757_1_ ? this.func_150755_b() : this.func_150753_a();
    }

    public BiMap<Integer, Class<? extends net.minecraft.network.Packet>> func_150754_b(boolean p_150754_1_)
    {
