...
public class MapData extends WorldSavedData
{
    ...
    public List<net.minecraft.world.storage.MapData.MapInfo> playersArrayList = new ArrayList();
    ...
    public Map<String, net.minecraft.world.storage.MapData.MapCoord> playersVisibleOnMap = new LinkedHashMap();
