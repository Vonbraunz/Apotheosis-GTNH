...
public abstract class BiomeGenBase
{
    ...
    protected List<net.minecraft.world.biome.BiomeGenBase.SpawnListEntry> spawnableWaterCreatureList;
    protected List<net.minecraft.world.biome.BiomeGenBase.SpawnListEntry> spawnableCaveCreatureList;
     ...
     */
    public List<net.minecraft.world.biome.BiomeGenBase.SpawnListEntry> getSpawnableList(EnumCreatureType p_76747_1_)
    {
    ...
    public Class<? extends net.minecraft.world.biome.BiomeGenBase> getBiomeClass()
    {
    ...
    public static class SpawnListEntry extends WeightedRandom.Item
        {
            ...
            public SpawnListEntry(Class<? extends net.minecraft.entity.EntityLiving> p_i1970_1_, int p_i1970_2_, int p_i1970_3_, int p_i1970_4_)
            {
                super(p_i1970_2_);
