...
public class MapGenVillage extends MapGenStructure
{
    ...
    public static List<net.minecraft.world.biome.BiomeGenBase> villageSpawnBiomes = Arrays.asList(new BiomeGenBase[] {BiomeGenBase.plains, BiomeGenBase.desert, BiomeGenBase.savanna});
