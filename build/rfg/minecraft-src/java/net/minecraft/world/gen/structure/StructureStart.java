...
public abstract class StructureStart
{
    ...
    protected LinkedList<net.minecraft.world.gen.structure.StructureComponent> components = new LinkedList();
    ...
    public LinkedList<net.minecraft.world.gen.structure.StructureComponent> getComponents()
    {
