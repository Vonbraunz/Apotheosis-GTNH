...
public abstract class CreativeTabs
{
     ...
     */
    @SideOnly(Side.CLIENT)
    public void displayAllReleventItems(List<net.minecraft.item.ItemStack> p_78018_1_)
    {
     ...
     */
    @SideOnly(Side.CLIENT)
    public void addEnchantmentBooksToList(List<net.minecraft.item.ItemStack> p_92116_1_, EnumEnchantmentType ... p_92116_2_)
    {
