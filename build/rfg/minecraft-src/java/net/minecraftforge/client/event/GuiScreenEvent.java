...
public class GuiScreenEvent extends Event 
{
    ...
    public static class InitGuiEvent extends GuiScreenEvent
    {
        ...
        public InitGuiEvent(GuiScreen gui, List<net.minecraft.client.gui.GuiButton> buttonList)
        {
            super(gui);
        ...
        {
            public Pre(GuiScreen gui, List<net.minecraft.client.gui.GuiButton> buttonList)
            {
        ...
        {
            public Post(GuiScreen gui, List<net.minecraft.client.gui.GuiButton> buttonList)
            {
                super(gui, buttonList);
            }
        }
    ...
    public static class ActionPerformedEvent extends GuiScreenEvent
    {
        ...
        public ActionPerformedEvent(GuiScreen gui, GuiButton button, List<net.minecraft.client.gui.GuiButton> buttonList)
        {
            super(gui);
            this.button = button;
        ...
        {
            public Pre(GuiScreen gui, GuiButton button, List<net.minecraft.client.gui.GuiButton> buttonList)
            {
        ...
        {
            public Post(GuiScreen gui, GuiButton button, List<net.minecraft.client.gui.GuiButton> buttonList)
            {
                super(gui, button, buttonList);
            }
        }
